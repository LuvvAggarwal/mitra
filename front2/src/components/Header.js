        ...
        return (
            <div className="nav-header bg-white shadow-xs border-0">
                <div className="nav-top">
                    <Link to="/">
                        <span className="d-block fredoka-font ls-3 fw-600 text-current font-xxl logo-text mb-0">Mitra </span>
                     </Link>
                ...
                <NavLink activeClassName="active" to="/defaultvideo" className="p-2 text-center ms-0 menu-icon center-menu-icon"><i className="feather-activity font-lg bg-greylight btn-round-lg theme-dark-bg text-grey-500 "></i></NavLink>
                ...
                <Link to="/userProfile" className="p-0 ms-3 menu-icon"><img src="assets/images/user.png" alt="user" className="w40 mt--1 rounded-circle" /></Link>
                    ...
                    <div className="container ps-0 pe-0">
                        <div className="nav-content">
                            <div className="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-2 mt-2">
                                <div className="nav-caption fw-600 font-xssss text-grey-500"><span>New </span>Actions</div>
