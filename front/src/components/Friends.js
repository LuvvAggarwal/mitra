            ...
            <div className="card w-100 shadow-xss rounded-xxl border-0 mb-3">
                ...
                <div className="wrap" key={index}>
                    <div className="card-body d-flex pt-0 ps-4 pe-4 pb-0 bor-0">
                        ...
                        <h4 className="fw-700 text-grey-900 font-xssss mt-1">{value.name} <span className="d-block font-xssss fw-500 mt-1 lh-3 text-grey-500">{value.friend} Followers {value.followers} </span></h4>
                    </div>
